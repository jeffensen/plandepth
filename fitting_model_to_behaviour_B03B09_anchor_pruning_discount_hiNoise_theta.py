...
from agents_discount_hiNoise_theta_anchor_pruning import BackInductionDiscountHiNoiseThetaAnchorPruning
...
def variational_inference(stimuli, mask, responses):
    ...
    # define agent
    agent = BackInductionDiscountHiNoiseThetaAnchorPruning(confs,
                          runs=runs,
...
localpath = 'P:/037/B3_BEHAVIORAL_STUDY/04_Experiment/Analysis_Scripts/SAT_Results/Results_anchor_pruning_discount_hiNoise_theta' # LG
...
def format_posterior_samples(infer):
    labels = [r'$\tilde{\beta}$', r'$\theta$', r'$\gamma_{hiNoise}$'] # , r'$\gamma_{loNoise}$'
...
fig.savefig(localpath + '/ELBO Testdaten_oa_anchor_pruning_discount_hiNoise_theta.jpg')
