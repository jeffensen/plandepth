...
text = ['Um im Weltraum zu überleben, musst du versuchen soviel Treibstoff wie müglich zu sammeln.' ... 
        ...
        '\n\n '...
        '\n\n RECHTS kostet dich dabei immer 2 Treibstoffeinheiten, wührend (S)prung 5 Treibstoffeinheiten verbraucht.']; 
...
text = ['Zuerst schauen wir uns an, was passiert, wenn du RECHTS wählst.' ...
        '\n RECHTS ermöglicht es dir im Uhrzeigersinn zum nächsten benachbarten Planeten zu reisen.' ...
...
text_2 = ['Im richtigen Experiment, kann es passieren, dass deine Reise nach (S)prung unzuverlässig ist'...
...
% text
text = ['Wenn du zwischen Planeten reist kannst unabhängig von den Kosten für RECHTS (-2) und (S)prung (-5)'... 
