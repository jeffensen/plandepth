...
text = ['Hallo Abenteurer!' ...
        ...
        '\n\n\n\n Um m?glichst viele Punkte zu sammeln, ist es wichtig, dass Sie Ihre Reisen immer im Voraus planen.'...        
        '\n\n\n\n Bevor es losgeht, zeige ich Ihnen jedoch, wie Sie im Weltraum ?berleben k?nnen.'];
     
% Draw all the text in one go
DrawFormattedText(window, text, 'center', screenYpixels * 0.25, white);

% Press Key to continue  
DrawFormattedText(window, 'Dr?cken Sie eine Taste, um fortzufahren.', ...
...
text = ['Kurz gesagt:'...
        '\n\n Um im Weltraum zu ?berleben, m?ssen Sie m?glichst viel Treibstoff sammeln, indem Sie von Planet zu Planet reisen.' ... 
        '\n\n\n\n Sie bereisen Planeten, indem Sie immer zwischen den Kommandos RECHTE PFEILTASTE und (S)prung w?hlen.'...
        '\n\n\n\n Planen Sie die Reisen sorgf?ltig im Voraus, um Treibstoff zu sparen und zu ?berleben.',...
        '\n\n\n\n RECHTE PFEILTASTE kostet Sie dabei immer 2 Treibstoffeinheiten, w?hrend (S)prung 5 Treibstoffeinheiten verbraucht.'...
        '\n\n\n\n Je nachdem auf welchem Planeten Sie landen, gewinnen oder verlieren Sie Treibstoff.',...
        '\n\n\n\n Im Folgenden werde ich Ihnen alles genauer erkl?ren.']; 
...
% text
text = ['Damit Sie nicht den ?berblick ?ber die Menge des verf?gbaren Treibstoffes verlieren,'...
         '\n\n zeigt der Balken am oberen Bildschirmrand Ihren aktuellen Treibstofflevel an.'...
        '\n\n\n Wenn Ihr Treibstofflevel gef?hrlich absinkt, f?rbt sich der Balken rot.'];
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
text = ['Jetzt zeige ich Ihnen, wie man Planeten bereist und erkl?re dabei die Kommandos.',...
        '\n\n\n\n Zuerst schauen wir uns an, was passiert, wenn Sie die RECHTE PFEILTASTE w?hlen.' ...
        '\n\n\n\n Die RECHTE PFEILTASTE erm?glicht es Ihnen, im Uhrzeigersinn zum n?chsten' ...
        '\n\n benachbarten Planeten zu reisen.' ...
        '\n\n\n\n Sie k?nnen dies nun ein paar Mal ausprobieren.']; 
...
text = ['Haben Sie bemerkt, wie der Treibstofflevel abgesunken ist?',...
         '\n\n\n\n Als n?chstes zeige ich Ihnen was beim Kommando (S)prung passiert.'];
...
text = [' Wenn Sie (S)prung w?hlen, reist Ihr Raumschiff zu einem nicht benachbarten Planeten.' ... 
        '\n\n\n\n Als n?chstes k?nnen Sie ausprobieren, was an jeder Planetenposition passiert,'...
        '\n\n wenn Sie (S)prung w?hlen.'...
        '\n\n\n\n Es ist wichtig, dass Sie sich das gezeigte Flugmuster gut einpr?gen.']; 
...
text = [' Hier sehen Sie das Flugmuster noch einmal als Ganzes.' ...
        ' Bitte pr?gen Sie es sich gut ein:',...
        '\n\n\n\n ']; 
...
text = [' Um Ihnen zu helfen, das Muster noch mehr zu verinnerlichen, spielen wir jetzt ein kleines Spiel.' ... 
        '\n\n\n\n Ich zeige Ihnen verschiedene Startpositionen und Sie k?nnen mit den Tasten 1-6 sagen,'...
        '\n\n\n auf welchem Zielplaneten Sie landen, wenn Sie (S)prung w?hlen.'...
        '\n\n\n\n Anschlie?end bekommen Sie ein Feedback, ob Sie richtig geantwortet haben.']; 
...
for NoPatternTrainings = 1:NoMiniBlocks
    ...
    for t = 1:NoTrials
            ...
            if Resp == RightAnswer(t)
                ...
                DrawFormattedText(window, 'Falsch, die richtige Antwort w?re:', 'center', 'center', white);  % ask
                vbl = Screen('flip', window);
                WaitSecs(2);
            end  
            p = state_transition_matrix(2, start, :);
...
DrawFormattedText(window, 'Als n?chstes zeige ich Ihnen eine Besonderheit des Kommandos (S)prung.',...
                  'center', 'center', white);
...
text = ['Im richtigen Experiment kann es passieren, dass Ihre Reise mit (S)prung unzuverl?ssig ist.'...
...
text = ['In manchen Planetensystemen befinden sich Asteroiden.'...
        '\n\n In diesen passiert es besonders h?ufig, dass Sie den Zielplaneten bei (S)prung verfehlen.'...
        '\n\n In den Planetensystemen ohne Asteroiden passiert das im Vergleich viel seltener.'...
        '\n\n\n\n\n\n Um Ihnen ein Gef?hl daf?r zu geben, k?nnen Sie (S)prung jetzt in beiden Bedingungen ausprobieren.'...
        '\n\n Beachten Sie, dass das Reisemuster dabei gleich bleibt und'...
        '\n\n lediglich weniger zuverl?ssig ist.']; 
...
text = ['Wir fangen mit Planetensystemen ohne Asteroiden an.'...
        '\n\n Hier landen Sie, wenn Sie (S)prung w?hlen, fast immer auf dem erwarteten Zielplaneten.'...
        '\n\n Hinweis: Die H?ufigkeit mit der Sie in dieser Bedingung Ihren Zielplaneten verfehlen,'...
        '\n\n ist ?ber das gesamte Experiment gleich.'];
...
text = ['Jetzt lernen Sie Planetensysteme mit Asteroiden kennen.'...
        ...
        '\n\n k?nnen Sie immer am Hintergrund erkennen.'...
        '\n\n\n\n In diesen Bedingungen ist das Kommando (S)prung hochgradig unzuverl?ssig.' ... 
        '\n\n\n\n Um Ihnen auch hierf?r ein Gef?hl zu geben, k?nnen Sie nun auch hier (S)prung'...
        ...
        '\n\n Auch in dieser Bedingung bleibt die H?ufigkeit, mit der Sie ihren Zielplaneten verfehlen, gleich.']; 
...
% text
text = ['Zus?tzlich zu dem Treibstoff, der Sie das Reisen kostet,' ...
        '\n\n kann Sie auch das Landen auf einem Planeten Treibstoff kosten,'...
        '\n\n aber Sie k?nnen auf manchen Planeten auch zus?tzlichen Treibstoff finden.'...
        '\n\n\n\n Ob und wie viel Sie gewinnen oder verlieren h?ngt davon ab, auf welchem Zielplaneten Sie landen.'...
        '\n\n\n\n Um zu ?berleben, ist es wichtig, dass Sie versuchen so viel Treibstoff wie m?glich zu sammeln.'...
        '\n\n\n\n Hierzu zeige ich Ihnen im n?chsten Schritt,' ...
...
DrawFormattedText(window, 'Bitte merken Sie sich die Treibstoffbelohnung f?r jeden Planeten: ', ...
                  'center',  screenYpixels*0.25, white); 
...
% text
text = ['In jedem neuen Planetensystem k?nnen Sie immer nur 2 oder 3 Planeten bereisen und dort Treibstoff sammeln.'...
         '\n\n Die Anzahl der gr?nen Quadrate zeigt Ihnen an, wie oft Sie reisen m?ssen,'...
         '\n\n bevor es weiter zum n?chsten Planetensystem geht.',...
         '\n\n\n\n Um zum n?chsten Planetensystem reisen zu k?nnen, m?ssen Sie also alle gr?nen Quadrate aufbrauchen.'];
...
% Summary text
text = ['Ich fasse noch einmal alles f?r Sie zusammen:' ...
        '\n\n\n Ihre Aufgabe ist es, m?glichst viel Treibstoff zu sammeln, indem Sie von Planet zu Planet reisen.'... 
        '\n\n\n  Sie haben entweder 2 oder 3 Reisen pro Planetensystem.'...
        '\n\n Sie k?nnen immer entweder zum Nachbarplaneten im Uhrzeigersinn reisen, was 2 Treibstoffeinheiten kostet,'...
        '\n\n oder f?r 5 Treibstoffeinheiten springen. Je nachdem auf welchem Planeten Sie landen,'...
        ...
        '\n\n auf einem seiner Nachbarplaneten landen. Das passiert besonders h?ufig in Planetensystemen'...
        '\n\n mit Asteroiden, kann aber auch (selten) in den anderen Planetensystemen passieren.'...
        '\n\n Die unterschiedlichen H?ufigkeiten, wie oft Sie in den beiden Bedingungen den Zielplaneten verfehlen,'...
        '\n\n bleiben w?hrend des gesamten Experimentes gleich.'];
...
text = [' Wenn Sie nur einen Schritt im Voraus planen, w?rden Sie wahrscheinlich direkt zum blauen Planeten springen.' ...
        '\n\n\n Danach w?ren Sie jedoch gezwungen, auf einen der roten Planeten zu springen.'...
        '\n\n Insgesamt w?rden Sie so mindestens 17 Treibstoffeinheiten verlieren (-5 +10 -2 -20)'...
        '\n\n\n\n ']; 
...
text = [' In diesem Planetensystem w?re es also besser gewesen, erst wenige Punkte zu verlieren,' ...
        ...
        '\n\n Insgesamt h?tten Sie so nur 4 Treibstoffeinheiten verloren (-2 -10 +10 -2)'...
        '\n\n\n\n ']; 
...
% text
text = ['Sie k?nnen die Aufgabe nun ein paar Mal ?ben.'...
        '\n\n Versuchen Sie dabei so zu planen, dass Sie insgesamt den bestm?glichen Reiseweg w?hlen.'];
...
for n = 1:NoMiniBlocks
    while true
        text = ['In K?rze erreichen Sie ein neues Planetensystem...'];
        ...
        if all(TestKey == correctResponses(n,:))
            text = ['Sehr gut, Sie haben den optimalen Reiseweg gew?hlt.'];
            correct = 1;
        else
...
% text
text = ['Gl?ckwunsch! Sie haben jetzt alles gelernt, was Sie f?r Ihr Weltraumabenteuer wissen m?ssen.' ... 
