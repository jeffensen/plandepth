...
class BackInductionDiscountHyperbolicThetaRealProbskmax30(object):
    def __init__(self,
    ...
    def set_parameters(self, trans_par=None, true_params=False):
        ...
        self.tp_mean1 = torch.tensor([.9, .5]).expand(self.batch_shape + (2,)) # used for hyperbolic discounting
