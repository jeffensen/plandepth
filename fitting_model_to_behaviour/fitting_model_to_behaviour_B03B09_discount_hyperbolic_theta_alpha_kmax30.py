...
pd.DataFrame(infer_oa.loss).to_csv(localpath + '/ELBO_oa_group_discount_hyperbolic_theta_kmax30.csv') 
...
df_nll_oa.to_csv(localpath + '/NLL_oa_group_discount_hyperbolic_theta_kmax30.csv') 
...
pd.DataFrame(infer_ya.loss).to_csv(localpath + '/ELBO_ya_group_discount_hyperbolic_theta_kmax30.csv') # 
...
df_nll_ya.to_csv(localpath + '/NLL_ya_group_discount_hyperbolic_theta_kmax30')
